...
fun ProductBagModel.toDomain(): ProductBag {
    return ProductBag(code, name, price, backgroundColor, quantity)
}

fun ProductBag.toData(): ProductBagModel {
    return ProductBagModel(code, name, price, backgroundColor, quantity)
}