...
import com.ericktijerou.cabifystore.domain.usecase.GetBagListUseCase
...
class GetBagListUseCaseTest {

    private val repository = mockk<BagRepository>()
    private val useCase = GetBagListUseCase(repository)

    @OptIn(ExperimentalCoroutinesApi::class)
    @Test
    fun `GIVEN GetBagList WHEN repository returns Success THEN returns data`() = runTest {
    ...
    fun `GIVEN GetBagList WHEN repository returns Failure THEN throw exception`() = runTest {
